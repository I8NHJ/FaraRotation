...
const char ROTATE_RX_ANTENNA_TO[]      = "*GRX";          // Plus up to 3 chars for degrees (-90/90) 3  // Enabled, No Logic
const char ROTATE_TX_ANTENNA_CW[]      = "*RTX1";                                                       // Completed
const char ROTATE_TX_ANTENNA_CCW[]     = "*RTX2";                                                       // Completed
const char ROTATE_TX_ANTENNA_TO[]      = "*GTX";          // Plus up to 3 chars for degrees (-90/90) 3  // Enabled, No Logic
const char SET_TARGET_GRID[]           = "*TG";           // Plus up to 6 chars for GRID                // Enabled, Partial Logic 
const char SYNC_TX_2_RX_ENABLE[]       = "*SRXTX1";                                                     // Enabled, No Logic
const char SYNC_TX_2_RX_DISABLE[]      = "*SRXTX0";                                                     // Enabled, No Logic
