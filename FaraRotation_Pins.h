...
#define rx_rotate_cw_pwm 4          // PWM CW output - must be PWM capable pin PWM: 2 to 13 and 44 to 46 for ATMEGA2560 REV 3. 
#define rx_rotate_ccw_pwm 5         // PWM CCW output - must be PWM capable pin)
#define rx_rotate_cw_dig 4          // DIGITAL CW output 
#define rx_rotate_ccw_dig 5         // DIGITAL CCW output 
...
#define tx_rotate_cw_pwm 6          // PWM CW output -  must be PWM capable pin PWM: 2 to 13 and 44 to 46 for ATMEGA2560 REV 3.
#define tx_rotate_ccw_pwm 7         // PWM CCW output - set to 0 to disable (must be PWM capable pin)
#define tx_rotate_cw_dig 6          // DIGITAL CW output 
#define tx_rotate_ccw_dig 7         // DIGITAL CCW output 
