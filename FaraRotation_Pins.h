...
#define rx_rotate_cw 6              // goes high to activate rotator CW rotation
#define rx_rotate_ccw 7             // goes high to activate rotator CCW rotation
...
#define rx_rotator_degs A0          // reads analog voltage from rotator - pin 4 on Yaesu connector

/*-------- TX Antenna pins definitions --------*/
#define tx_rotate_cw 8              // goes high to activate rotator CW rotation
#define tx_rotate_ccw 9             // goes high to activate rotator CCW rotation
...
#define tx_rotator_degs A1          // reads analog voltage from rotator
